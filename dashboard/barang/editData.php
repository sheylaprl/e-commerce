...
$data = $koneksi->query("SELECT * FROM barang WHERE id='$id'");
...
if (isset($_POST["submit"]))
{
  ...
  $query = "UPDATE barang SET  nama_barang='$nama_barang', harga='$harga', ukuran='$ukuran', stock='$stock', kategori='$kategori', gambar='$gambar', keterangan='$keterangan' WHERE id='$id'";
        ...
        <div class="mt-3 sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              ...
              required>
              <option <?php if($data['kategori']== "Dress") echo "selected" ?> >Dress</option>
              <option <?php if($data['kategori']== "Bags") echo "selected" ?> >Bags</option>
              <option <?php if($data['kategori']== "Acessories") echo "selected" ?> >Acessories</option>
            </select>
          </div>
        </div>
        ...
        <div class="mt-3 sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              ...
              required
              >
              <option <?php if($data['kategori']== "S") echo "selected" ?> >S</option>
              <option <?php if($data['kategori']== "M") echo "selected" ?> >M</option>
              <option <?php if($data['kategori']== "L") echo "selected" ?> >L</option>
              <option <?php if($data['kategori']== "XL") echo "selected" ?> >XL</option>
            </select>
          </div>
        </div>
