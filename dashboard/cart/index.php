...
$data = $koneksi->query("SELECT * FROM cart");
?>


<div class="w-full text-black bg-{#EFF0FB} p-10 flex flex-col items-center">
   ...
   <table class="border-collapse border border-l-slate-400 w-full">
    <thead>
      <tr>
        ...
        <th class="border border-slate-300 p-2">Id_User</th>
        <th class="border border-slate-300 p-2">Id_Barang</th>
        ...
        <th class="border border-slate-300 p-2">Create_at</th>
        <th class="border border-slate-300 p-2">Update_at</th>
